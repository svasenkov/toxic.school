...
function runOut(min, max) {
  ...
  var maxX = window.screen.width - rect.left;
  var maxY = window.screen.height - rect.top;
  ...
  if (myFuncCalls > 2) {
    ...
    button.style.transform = "translate(50%)"; // button.style.display = "none";
  } else {
    button.style.left = getRandomInt(0, maxX) + "px";
    button.style.top = getRandomInt(0, maxY) + "px";
    button.style.transform = "translate(0)"; // button.style.transform = "translateY(-100%)";
